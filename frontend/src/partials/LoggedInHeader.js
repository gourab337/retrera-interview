        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:flex-grow">
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <Link to="/partner" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Partner</Link>
              </li>
              {/*
              <li>
                <Link to="/pricing" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-3 flex items-center transition duration-150 ease-in-out">Plan</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-3 flex items-center transition duration-150 ease-in-out">Partner</Link>
              </li>
              <li>
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              {/*
              <li>
                <Link to="/plan" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Plan</Link>
              </li>
              <li>
                <Link to="/partner" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Partner</Link>
              </li>
                    ...
                    return (
                      <>
                        <Dropdown title={user.name}>
                          <li>
                            <Link to="/logout" className="font-medium text-sm text-gray-600 hover:text-gray-900 flex py-2 px-5 leading-tight">Logout</Link>
                          </li>
                        </Dropdown>
                      </>
                    )
            ...
            <div ref={mobileNav}>
              ...
              >
                <ul className="px-5 py-2">
                  <li>
                    <Link to="/partner" className="flex text-gray-600 hover:text-gray-900 py-2">Partner</Link>
                  </li>
                  {/*
                  <li>
                    <Link to="/pricing" className="flex text-gray-600 hover:text-gray-900 py-2">Plan</Link>
                  </li>
                  <li>
                    <Link to="/about" className="flex text-gray-600 hover:text-gray-900 py-2">Partner</Link>
                  </li>
                  <li>
                      ...
                      context => {
                        ...
                        if (user) {
                          return (
                            <>
                              <li>
                                <p className="flex font-medium w-full text-gray-600 py-2 justify-center">{user.name}</p>
                              </li>
                              <li>
                                <Link to="/logout" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center">Logout</Link>
                              </li>
                            </>
                          )
                        }
